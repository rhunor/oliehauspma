...
// POST /api/projects/[id]/risks/[riskId]/comments - Add comment to risk
export async function POST(
  ...
  try {
    ...
    const risk = await db.collection('risks').findOne({
    ...
    const risksCollection = db.collection<RiskDocument>('risks');
